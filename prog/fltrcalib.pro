...
for ii=0,n_elements(fltrcode1)-1 do begin
	...
	printf,1,format='(A-10,",",A-10,",",F5.3,",","[",I4,":",I4,"]",",",I,",","[",I4,":",I4,"]",",",I,",","[",I4,":",I4,"]",",",I )',fltrcode1[ii],fltrcode2[ii],exptime[ii],inband[0],inband[1],round(ibpxcnt),rband[0],rband[1],round(rlpxcnt),bband[0],bband[1],round(blpxcnt)
